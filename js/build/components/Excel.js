...
var Excel = function (_Component) {
  ...
  function Excel() {
    ...
    _this.state = {
      data: _CRUDStore2.default.getData(), // データ
  ...
  _createClass(Excel, [{
    ...
    value: function componentWillReceiveProps() {
      this.setState({ data: _CRUDStore2.default.getData() });
    }
  }, {
    key: '_sortCallback',
    ...
    value: function _renderDeleteDialog() {
      var index = this.state.dialog ? this.state.dialog.idx : null;
      (0, _invariant2.default)(typeof index === 'number', 'ステートdialogが不正です');
      var first = _CRUDStore2.default.getRecord(index);
      (0, _invariant2.default)(first, 'レコードが取得できませんでした');
    ...
    value: function _renderTable() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _CRUDStore2.default.getData().map(function (row, rowidx) {
            return _react2.default.createElement(
              'tr',
              { key: rowidx },
